...
public class ConsolaOlimpicos
{
	...
	/**
	 * Modificaciones Taller 1
	 */
	private void ejecutargetCountry()
	{
		System.out.println("\n" + "Pais que representa" + "\n");
		
		String name = input("Ingrese el nombre");
		String country = calculadora.getCountry(name);
		if(country!="")
		{
			System.out.println("El atleta "+ name +" representa al pais: " + country);
		}
		else
		{
			System.out.println("Nombre de atleta invalido");
		}
